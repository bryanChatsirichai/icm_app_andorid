...
public class Rotation_front_motor_Activity extends AppCompatActivity {
    ...
    private void init () {
        ...
        switch (myGlobals.front_rotation_direction) {
            case 0:
                // code block
                rotation_front_motor_0_button.setText("Rotation-0 Selected");
                rotation_front_motor_1_button.setText("Rotation-1");
                break;
            case 1:
                // code block
                rotation_front_motor_0_button.setText("Rotation-0");
                rotation_front_motor_1_button.setText("Rotation-1 Selected");
                break;
    ...
    BroadcastReceiver messageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(Objects.equals(functionName, "switchFrontMotorRotation")){
                ...
                Toast.makeText(Rotation_front_motor_Activity.this, "Set",
